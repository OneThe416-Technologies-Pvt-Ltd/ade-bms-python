...
a = Analysis(
    ...
    ('assets/icons/blank-check-box.png', 'assets/icons'),
    ('assets/icons/square.png', 'assets/icons'),
    ('assets/icons/switch-on.png', 'assets/icons'),
    ('assets/icons/switch-off.png', 'assets/icons'),],
    hiddenimports=[],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
