...
def create_can_report_pdf(serial_number, protocol):
    try:
        ...
        if protocol == "CAN":
            logger.info(f"{serial_number} test1 pdf")
            ...
            logger.info(f"{serial_number} test2 pdf")
        ...
        if general_data.empty or charging_data.empty or discharging_data.empty:
            logger.info(f"{general_data} general_data pdf")
            logger.info(f"{charging_data} charging_data pdf")
            logger.info(f"{discharging_data} discharging_data pdf")
